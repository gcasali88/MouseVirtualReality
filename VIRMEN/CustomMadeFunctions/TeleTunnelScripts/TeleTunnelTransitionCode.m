...
function vr = TeleTunnelTransitionCode(vr)
...
%             vr.position(2) = vr.cstart;vr.dp(:) = 0;vr.velocity(:) = 0;
%             %vr.text(1).string = ['EXPERIMENT OVER']; 
%             if ~isnan(vr.keyPressed)>0;vr = terminationCodeFun(vr);end;