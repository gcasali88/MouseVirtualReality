function [ mtint ] = postprocess_DACQ_dataVR( mtint,VR )
...
Vars = daVarsStruct;
mtint.Ephys.led_pos = mtint.pos.led_pos;
mtint.Ephys.ts = mtint.pos.ts;
mtint.Ephys.led_pix = mtint.pos.led_pix;
mtint.Ephys.trial_duration = length(mtint.pos.led_pos) / Vars.pos.sampleRate ; 
% get header info
mtint.Ephys.header = mtint.header;
