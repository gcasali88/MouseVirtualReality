...
function [] = write_cut_file( spikeAssignment, filePath, fileStem, exact_cut_name, tetrodeNo)
...
% Write main data
fprintf(fid,[ 'Exact_cut_for: ' exact_cut_name ]); fprintf(fid,' spikes: %6.0d%c%c',nSpikes,13,10);
