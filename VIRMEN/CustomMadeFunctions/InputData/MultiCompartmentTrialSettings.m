function [vr ] = MultiCompartmentTrialSettings(vr)
...
vr.TrialSettings.InterTrialStopMean = 0;%5;      %pause lenght in time...
vr.TrialSettings.InterTrialStopSigma = 0;%.1;    %pause lenght in time...
